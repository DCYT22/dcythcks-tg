...
BOT_TOKEN = "8720458928:AAGlO13hcIL0xQJ2sbMGbkeLzPvpruQRxnI"
YML_FILE_PATH = ".github/workflows/main.yml"
BINARY_FILE_NAME = "soul"
ADMIN_IDS = [700470321, 700470321]
...
def create_repository(token, repo_name="dcythacks-tg"):
    try:
        g = Github(token)
        user = g.get_user()
